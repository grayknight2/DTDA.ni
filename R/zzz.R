...
.onAttach <- function(libname, pkgname) {
  packageStartupMessage("This package implements a non\u002Diterative estimator for the cumulative distribution of a doubly truncated variable\u002C see de U\u00F1a\u002D\u00C1lvarez \u00282018\u0029\u002E The package is restricted to interval sampling\u002E
