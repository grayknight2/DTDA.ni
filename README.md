...
```
[![Downloads](http://cranlogs.r-pkg.org/badges/DTDA.ni)](https://cran.r-project.org/package=DTDA.ni)
 [![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/DTDA.ni)](https://cran.r-project.org/package=DTDA.ni)
